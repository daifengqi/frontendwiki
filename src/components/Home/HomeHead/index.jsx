  ...
  return (
    ...
    >
      <div className={styles.svgBlock + " flexCenter"}>
        ...
        >
          <path
            d="M166.912 799.744q-28.672 28.672-69.12 28.672t-69.12-28.672q-29.69599999-28.672-29.696-68.608t29.696-68.608l382.976-380.928q12.288-14.336 30.72-19.968t38.912-4.608 40.448 8.704 34.304 22.016l376.832 374.784q29.69599999 28.672 29.696 68.608t-29.696 68.608q-14.336 14.336-32.256 21.504t-36.864 7.168-37.376-7.168-32.768-21.504l-313.344-309.248z"
            p-id="4664"
            fill="#ffffff88"
          ></path>
        </svg>
